...
非常數的屬性名稱（如static或其他的）是以**小寫駝峰式字型命**名（非常數的屬性名稱（如static或其他的）是以小寫駝峰式字型命名（LowerCamelCase）
這些名稱通常都是名詞或名詞片語，例如： computerValue 或 index）這些名稱通常都是名詞或名詞片語，例如： computerValue 或 index
